...
import { ShoppingCart, Truck, Clock, AlertTriangle, Package, FileWarning, DollarSign } from "lucide-react";
import {
    ...
    <>
      ...
      <main className="flex-1 px-7 pb-16 pt-6">
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm text-muted-foreground">SLA, ciclo, problemas, aging e backlog.</p>
        </div>
